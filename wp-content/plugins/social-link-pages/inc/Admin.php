...
//		add_action(
//			Social_Link_Pages()->plugin_name_friendly . '_do_migration',
//			[ $this, 'migration_setup' ]
//		);
	}
...
//				],
	...
	/**
	 * Set poll key for users for version 1.3.4
	 *
	 * @param array $plugin_option_data
	 */
//	public function migration_setup( $plugin_option_data ) {
//		global $wpdb;
//
//		$user_ids = $wpdb->get_col( "SELECT ID FROM $wpdb->users" );
//
//		if ( ! empty( $user_ids ) ) {
//			$meta_key   = Social_Link_Pages()->plugin_name_friendly . '_app_settings';
